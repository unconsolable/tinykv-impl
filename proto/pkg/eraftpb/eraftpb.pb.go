...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{0}
}
...
func (MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{1}
}
...
func (ConfChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{2}
}
...
type Message struct {
	...
	Hint                 *AppendRejectHint `protobuf:"bytes,11,opt,name=hint" json:"hint,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{3}
}
...
func (m *Message) GetHint() *AppendRejectHint {
	if m != nil {
		return m.Hint
	}
	return nil
...
// MsgAppend Reject Hint, adapted from 6824
type AppendRejectHint struct {
	...
	// If true, XTerm and XIndex is valid
	HasXTerm             bool     `protobuf:"varint,4,opt,name=hasXTerm,proto3" json:"hasXTerm,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *AppendRejectHint) Reset()         { *m = AppendRejectHint{} }
func (m *AppendRejectHint) String() string { return proto.CompactTextString(m) }
func (*AppendRejectHint) ProtoMessage()    {}
func (*AppendRejectHint) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{4}
}
func (m *AppendRejectHint) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AppendRejectHint) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AppendRejectHint.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *AppendRejectHint) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AppendRejectHint.Merge(dst, src)
}
func (m *AppendRejectHint) XXX_Size() int {
	return m.Size()
}
func (m *AppendRejectHint) XXX_DiscardUnknown() {
	xxx_messageInfo_AppendRejectHint.DiscardUnknown(m)
}

var xxx_messageInfo_AppendRejectHint proto.InternalMessageInfo

func (m *AppendRejectHint) GetXLen() uint64 {
	if m != nil {
		return m.XLen
	}
	return 0
...
func (m *AppendRejectHint) GetXTerm() uint64 {
	if m != nil {
		return m.XTerm
	}
	return 0
...
func (m *AppendRejectHint) GetXIndex() uint64 {
	if m != nil {
		return m.XIndex
	}
	return 0
...
func (m *AppendRejectHint) GetHasXTerm() bool {
	if m != nil {
		return m.HasXTerm
	}
	return false
...
func (*HardState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{5}
}
...
func (*ConfState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{6}
}
...
func (*ConfChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_57bee7d9e8e4c5d6, []int{7}
}
...
func init() {
	...
	proto.RegisterType((*AppendRejectHint)(nil), "eraftpb.AppendRejectHint")
...
func (m *Message) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Hint != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Hint.Size()))
		n4, err := m.Hint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *AppendRejectHint) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AppendRejectHint) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.XLen != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.XLen))
	}
	if m.XTerm != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.XTerm))
	}
	if m.XIndex != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.XIndex))
	}
	if m.HasXTerm {
		dAtA[i] = 0x20
		i++
...
func (m *AppendRejectHint) Size() (n int) {
	var l int
	_ = l
	if m.XLen != 0 {
		n += 1 + sovEraftpb(uint64(m.XLen))
	}
	if m.XTerm != 0 {
		n += 1 + sovEraftpb(uint64(m.XTerm))
	}
	if m.XIndex != 0 {
		n += 1 + sovEraftpb(uint64(m.XIndex))
	}
	if m.HasXTerm {
		n += 2
	}
...
func (m *AppendRejectHint) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AppendRejectHint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AppendRejectHint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasXTerm", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func init() { proto.RegisterFile("eraftpb.proto", fileDescriptor_eraftpb_57bee7d9e8e4c5d6) }

var fileDescriptor_eraftpb_57bee7d9e8e4c5d6 = []byte{
	// 727 bytes of a gzipped FileDescriptorProto
	,
}
